    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dealer_center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vehicle_dealer_center', to='dealers_and_dealer_centers.dealercenter', verbose_name='Наименование дилерского центра')),
            ],
            options={
