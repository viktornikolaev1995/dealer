    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone_number', models.CharField(blank=True, max_length=50, verbose_name='Официальный номер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_saloons', models.ManyToManyField(related_name='dealer_centers', to='dealers_and_dealer_centers.DealerCenter', verbose_name='Дилерские центры')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_mileage', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Пробег')),
                ('type_of_vehicle_passport', models.CharField(blank=True, max_length=100, verbose_name='Тип ПТС')),
                ('owners', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Количество владельцев')),
                ('image', models.ImageField(blank=True, null=True, upload_to='vehicle/%Y/%m/%d/', verbose_name='Изображение')),
                ...
                ('dealer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='vehicle_dealer', to='dealers_and_dealer_centers.dealer', verbose_name='Наименование дилера')),
                ('dealer_center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='vehicle_dealer_center', to='dealers_and_dealer_centers.dealercenter', verbose_name='Наименование дилерского центра')),
            ],
            options={
